    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-white/20 p-1">
      ...
      >
        ...
        >
          ...
          <form className="flex flex-col space-y-2 md:space-y-3 lg:space-y-4 mb-2 md:mb-4 lg:mb-6">
            <input
              type="text"
            ...
            <button
              type="submit"
              className="bg-white text-[#C20000] font-lilita font-bold p-2 md:p-3 lg:p-3 text-sm md:text-base lg:text-2xl rounded-[2rem] hover:bg-gray-200 transition"
            >
              LET’S GET COOKING
            </button>
          </form>
