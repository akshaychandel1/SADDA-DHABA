...
>
  ...
  <div className="relative w-full flex justify-center">
    ...
    `}</style>
      ...
      <motion.div
  className="bg-[#C20000] text-white rounded-[3rem] px-9 sm:px-15 max-w-8xl mx-6 2xl:mx-15 text-center 2xl:py-26 py-24 my-24"
...
>
  {/* Heading */}
  <h2 className="text-5xl sm:text-6xl md:text-[7.5rem] font-barber mb-24">
