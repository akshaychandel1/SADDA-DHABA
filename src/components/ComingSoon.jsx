...
export default function ComingSoon() {
  ...
  return (
    <div className="flex flex-col min-h-screen m-2 pt-5 pb-5 items-center rounded-4xl justify-center bg-[#C20000] text-white">
      {/* Logo / Title */}
      <img className="w-52" src={LogoText} alt="Logo Text" />
      ...
      <p className="text-center text-sm md:text-base mb-6 px-[28px] md:px-0 mt-4">
        Saada Halwai is almost here to serve you a taste of tradition with a
        twist.
      </p>
      ...
      flex items-center"
            >
              {Array.from({ length: 20 }).map((_, i) => (
                <span
                  key={i}
                  className="font-lilita flex items-center text-sm sm:text-base md:text-lg mr-4"
                >
                  <img
                    src={CharacterHead}
                    alt="Character Head"
      ...
      <p className="text-center text-sm md:text-base mb-6 px-[28px] md:px-0">
        But why wait? We’re already taking orders. Drop your details below and
        let’s get the mithai rolling..
      </p>
      {/* Contact Form */}
